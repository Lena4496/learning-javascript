...
(() => {
    ...
    document.getElementById("run").addEventListener("click",() => {
        ...
        /* ds la console, (prendre tableau , people, lui appliquer la fonction .reduce 
         ((somme, avec la valeur current ) => fleche pour la fonction somme ou acculumator + valeur current "." ce qu'on veut ici age, init à 0 l'acuumulator))*/
    });
