...
- Retranscris [ce document Texte](doc-le-paysan-chinois.txt) en sémantique html, donc en utilisant les bons blocs html : Utilise les balises suivantes: `h1`, `h2`, `blockquote`, `q`, `p`, `img`, `hr`, `figure` et `caption`, `table`, `th`, `tr`, `td`, `ul` et `ol` et `li`. 
- Eviter les`div` et les`span` : elles n'apportent aucune sémantique. 
...
[Formulaire de remise du projet](https://docs.google.com/spreadsheets/d/1HFAKXWx668Q4tXMiDq5kKZ1vujwXoeX_NjvGQeVDYXA/edit#gid=2014276784)
